...
abstract class MapRepository{
  ...
  Future<Either<Failure, String>> updateUserLocationUseCase({required double latitude, required double longitude});
  Future<Either<Failure, PlaceData>> getUserLocationUseCase();
}