    ...
    return Column(
      children: [
        BlocBuilder<HomeBloc, HomeState>(
          buildWhen: (previous, current) => previous.brandsProducts != current.brandsProducts,
          builder: (context, state) {
            return Column(
              children: List.generate(state.brands.isEmpty ? 1 : state.brands.length, (index) {
                return Column(
                  children: [
                    state.brands.isEmpty ? const SectionShimmerLoading() :
                    SectionWidget(
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: state.brands.isEmpty ? 3 : state.brandsProducts[state.brands[index].id]!.length ,
                        shrinkWrap: true,
