...
@RoutePage()
class ChatSupportScreen extends StatelessWidget implements AutoRouteWrapper {
            ...
            Expanded(
              child: BlocBuilder<ChatSupportCubit, ChatSupportState>(
                ...
                builder: (context, state) {
                  if (state.chatMessages.isEmpty && state.chatMessagesState == CubitState.success) {
                    ...
                    return ListView(
                      ...
                      children: [
                        ListView.builder(
                          itemCount: state.chatMessages.isEmpty ? 8 : state.chatMessages.length,
                          shrinkWrap: true,
                          reverse: true,
                          padding: EdgeInsets.zero,
