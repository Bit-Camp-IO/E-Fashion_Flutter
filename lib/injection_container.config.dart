...
import 'package:efashion_flutter/presentation/shared/bloc/tokens_cubit/tokens_cubit.dart'
    as _i93;
import 'package:efashion_flutter/register_module.dart' as _i101;
...
import 'package:efashion_flutter/shared/api/authenticated_interceptor.dart'
    as _i64;
import 'package:efashion_flutter/shared/api/dio_logger.dart' as _i24;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i24.DioLogInterceptor>(() => _i24.DioLogInterceptor());
    gh.lazySingleton<_i25.EditProductQuantityUseCase>(
        () => _i25.EditProductQuantityUseCase(gh<_i10.CartRepository>()));
    gh.lazySingleton<_i26.ForgetPasswordUseCase>(
        () => _i26.ForgetPasswordUseCase(gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i27.GetCartProductsUseCase>(
        () => _i27.GetCartProductsUseCase(gh<_i10.CartRepository>()));
    gh.lazySingleton<_i28.GetChatMessagesUseCase>(
        () => _i28.GetChatMessagesUseCase(gh<_i14.ChatSupportRepository>()));
    ...
    gh.lazySingleton<_i37.NotificationsDataSource>(() =>
        _i37.NotificationsDataSourceImpl(
            gh<_i3.ApiConsumer>(instanceName: 'authenticatedConsumer')));
    gh.lazySingleton<_i38.NotificationsRepository>(() =>
        _i39.NotificationsRepositoryImpl(gh<_i37.NotificationsDataSource>()));
    gh.factory<_i40.OrdersCubit>(
        () => _i40.OrdersCubit(gh<_i32.GetOrdersListUseCase>()));
    gh.lazySingleton<_i41.ProductRemoteDataSource>(() =>
        _i42.ProductRemoteDataSourceImpl(
            gh<_i3.ApiConsumer>(instanceName: 'authenticatedConsumer')));
    gh.lazySingleton<_i43.ProductRepository>(
        () => _i44.ProductRepositoryImpl(gh<_i41.ProductRemoteDataSource>()));
    gh.lazySingleton<_i45.RemoveProductFromCartUseCase>(
        () => _i45.RemoveProductFromCartUseCase(gh<_i10.CartRepository>()));
    gh.lazySingleton<_i46.RemoveProductFromFavoriteListUseCase>(() =>
        _i46.RemoveProductFromFavoriteListUseCase(
            gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i47.ResetPasswordUseCase>(
        () => _i47.ResetPasswordUseCase(gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i48.SearchForProductsUseCase>(
        () => _i48.SearchForProductsUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i49.SendMessageUseCase>(
        () => _i49.SendMessageUseCase(gh<_i14.ChatSupportRepository>()));
    gh.lazySingleton<_i50.SubscribeToNotificationsUseCase>(() =>
        _i50.SubscribeToNotificationsUseCase(
            gh<_i38.NotificationsRepository>()));
    gh.lazySingleton<_i51.UnAuthenticatedInterceptor>(
        () => _i51.UnAuthenticatedInterceptor());
    ...
    gh.lazySingleton<_i53.UpdateUserLocationUseCase>(
        () => _i53.UpdateUserLocationUseCase(gh<_i35.MapRepository>()));
    ...
    gh.lazySingleton<_i61.AddOrEditProductReviewUseCase>(
        () => _i61.AddOrEditProductReviewUseCase(gh<_i43.ProductRepository>()));
    ...
    gh.lazySingleton<_i63.AddProductToFavoriteListUseCase>(() =>
        _i63.AddProductToFavoriteListUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i64.AuthenticatedInterceptor>(() =>
        _i64.AuthenticatedInterceptor(gh<_i33.GetUserAccessTokenUseCase>()));
    gh.factory<_i65.CartCubit>(() => _i65.CartCubit(
          gh<_i62.AddProductToCartUseCase>(),
          gh<_i45.RemoveProductFromCartUseCase>(),
          gh<_i27.GetCartProductsUseCase>(),
          gh<_i25.EditProductQuantityUseCase>(),
          gh<_i22.CreatePaymentIntentUseCase>(),
        ));
    gh.lazySingleton<_i66.ChangeAppThemeUseCase>(() =>
        _i66.ChangeAppThemeUseCase(themeRepository: gh<_i57.UserRepository>()));
    gh.factory<_i67.ChangePasswordCubit>(() => _i67.ChangePasswordCubit(
          gh<_i33.GetUserAccessTokenUseCase>(),
          gh<_i12.ChangePasswordUseCase>(),
        ));
    gh.factory<_i68.ChatSupportCubit>(() => _i68.ChatSupportCubit(
          gh<_i33.GetUserAccessTokenUseCase>(),
          gh<_i21.CreateOrJoinChatUseCase>(),
          gh<_i28.GetChatMessagesUseCase>(),
          gh<_i49.SendMessageUseCase>(),
          gh<_i29.GetChatStreamUseCase>(),
          gh<_i17.CloseSocketConnectionUseCase>(),
        ));
    gh.factory<_i69.CollectionsCubit>(() => _i69.CollectionsCubit(
    ...
    gh.factory<_i70.ForgetPasswordCubit>(() => _i70.ForgetPasswordCubit(
          ...
          gh<_i47.ResetPasswordUseCase>(),
        ));
    gh.lazySingleton<_i71.GetAllBrandsProductsUseCase>(
        () => _i71.GetAllBrandsProductsUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i72.GetAppThemeUseCase>(() =>
        _i72.GetAppThemeUseCase(themeRepository: gh<_i57.UserRepository>()));
    gh.lazySingleton<_i73.GetBrandProductsUseCase>(
        () => _i73.GetBrandProductsUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i74.GetBrandsUseCase>(
        () => _i74.GetBrandsUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i75.GetCategoriesUseCase>(
        () => _i75.GetCategoriesUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i76.GetFavoriteProductsUseCase>(
        () => _i76.GetFavoriteProductsUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i77.GetNotificationsListUseCase>(() =>
        _i77.GetNotificationsListUseCase(gh<_i38.NotificationsRepository>()));
    gh.lazySingleton<_i78.GetPlaceLatitudeAndLongitudeUseCase>(() =>
        _i78.GetPlaceLatitudeAndLongitudeUseCase(gh<_i35.MapRepository>()));
    gh.lazySingleton<_i79.GetPlacesSuggestionsUseCase>(
        () => _i79.GetPlacesSuggestionsUseCase(gh<_i35.MapRepository>()));
    gh.lazySingleton<_i80.GetProductDetailsUseCase>(
        () => _i80.GetProductDetailsUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i81.GetProductReviewsAndRatingsUseCase>(() =>
        _i81.GetProductReviewsAndRatingsUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i82.GetProductsOffersUseCase>(
        () => _i82.GetProductsOffersUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i83.GetUserDataUseCase>(
        () => _i83.GetUserDataUseCase(gh<_i57.UserRepository>()));
    gh.lazySingleton<_i84.GetUserFavoriteProductsIdsUseCase>(() =>
        _i84.GetUserFavoriteProductsIdsUseCase(gh<_i43.ProductRepository>()));
    gh.lazySingleton<_i85.GetUserLocationUseCase>(
        () => _i85.GetUserLocationUseCase(gh<_i35.MapRepository>()));
    gh.lazySingleton<_i86.GetUserProductReviewUseCase>(
        () => _i86.GetUserProductReviewUseCase(gh<_i43.ProductRepository>()));
    gh.factory<_i87.HomeBloc>(() => _i87.HomeBloc(
          gh<_i75.GetCategoriesUseCase>(),
          gh<_i82.GetProductsOffersUseCase>(),
          gh<_i74.GetBrandsUseCase>(),
          gh<_i71.GetAllBrandsProductsUseCase>(),
        ));
    gh.factory<_i88.MapBloc>(() => _i88.MapBloc(
          gh<_i79.GetPlacesSuggestionsUseCase>(),
          gh<_i85.GetUserLocationUseCase>(),
          gh<_i53.UpdateUserLocationUseCase>(),
          gh<_i78.GetPlaceLatitudeAndLongitudeUseCase>(),
        ));
    gh.singleton<_i89.NotificationsCubit>(_i89.NotificationsCubit(
      gh<_i77.GetNotificationsListUseCase>(),
      gh<_i50.SubscribeToNotificationsUseCase>(),
      gh<_i52.UnSubscribeFromNotificationsUseCase>(),
      gh<_i16.CheckIfTokensExistUseCase>(),
    ));
    gh.factory<_i90.SearchBloc>(
        () => _i90.SearchBloc(gh<_i48.SearchForProductsUseCase>()));
    gh.factory<_i91.SignupCubit>(() => _i91.SignupCubit(
          gh<_i59.UserSignUpUseCase>(),
          gh<_i89.NotificationsCubit>(),
        ));
    gh.factory<_i92.ThemeCubit>(() => _i92.ThemeCubit(
          gh<_i72.GetAppThemeUseCase>(),
          gh<_i66.ChangeAppThemeUseCase>(),
        ));
    gh.factory<_i93.TokensCubit>(() => _i93.TokensCubit(
          gh<_i16.CheckIfTokensExistUseCase>(),
          gh<_i23.DeleteTokensUseCase>(),
          gh<_i89.NotificationsCubit>(),
        ));
    gh.lazySingleton<_i94.UpdateProfilePictureUseCase>(
        () => _i94.UpdateProfilePictureUseCase(gh<_i57.UserRepository>()));
    gh.lazySingleton<_i95.UpdateUserDataUseCase>(
        () => _i95.UpdateUserDataUseCase(gh<_i57.UserRepository>()));
    gh.factory<_i96.DetailsCubit>(() => _i96.DetailsCubit(
          gh<_i80.GetProductDetailsUseCase>(),
          gh<_i81.GetProductReviewsAndRatingsUseCase>(),
          gh<_i61.AddOrEditProductReviewUseCase>(),
          gh<_i86.GetUserProductReviewUseCase>(),
        ));
    gh.factory<_i97.DiscoverBloc>(() => _i97.DiscoverBloc(
          gh<_i73.GetBrandProductsUseCase>(),
          gh<_i82.GetProductsOffersUseCase>(),
        ));
    gh.factory<_i98.FavoriteCubit>(() => _i98.FavoriteCubit(
          gh<_i84.GetUserFavoriteProductsIdsUseCase>(),
          gh<_i63.AddProductToFavoriteListUseCase>(),
          gh<_i46.RemoveProductFromFavoriteListUseCase>(),
          gh<_i80.GetProductDetailsUseCase>(),
          gh<_i76.GetFavoriteProductsUseCase>(),
        ));
    gh.factory<_i99.LoginCubit>(() => _i99.LoginCubit(
          gh<_i55.UserLoginUseCase>(),
          gh<_i89.NotificationsCubit>(),
        ));
    gh.factory<_i100.ProfileCubit>(() => _i100.ProfileCubit(
          gh<_i83.GetUserDataUseCase>(),
          gh<_i94.UpdateProfilePictureUseCase>(),
          gh<_i95.UpdateUserDataUseCase>(),
        ));
    return this;
  }
}
