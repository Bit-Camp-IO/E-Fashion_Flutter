...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i13.DeleteTokensUseCase>(
        () => _i13.DeleteTokensUseCase(gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i14.DioInterceptor>(() => _i14.DioInterceptor());
    gh.lazySingleton<_i15.DioLogInterceptor>(() => _i15.DioLogInterceptor());
    gh.lazySingleton<_i16.EditProductQuantityUseCase>(
        () => _i16.EditProductQuantityUseCase(gh<_i10.CartRepository>()));
    gh.lazySingleton<_i17.ForgetPasswordUseCase>(
        () => _i17.ForgetPasswordUseCase(gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i18.GetAccessTokenUseCase>(
        () => _i18.GetAccessTokenUseCase(gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i19.GetCartProductsUseCase>(
        () => _i19.GetCartProductsUseCase(gh<_i10.CartRepository>()));
    gh.lazySingleton<_i20.MapDataSource>(() => _i20.MapDataSourceImpl(
          gh<_i3.ApiConsumer>(instanceName: 'mainApiConsumer'),
          gh<_i3.ApiConsumer>(instanceName: 'mapsApiConsumer'),
        ));
    gh.lazySingleton<_i21.MapRepository>(
        () => _i22.MapRepositoryImpl(gh<_i20.MapDataSource>()));
    gh.lazySingleton<_i23.ProductRemoteDataSource>(() =>
        _i24.ProductRemoteDataSourceImpl(
            gh<_i3.ApiConsumer>(instanceName: 'mainApiConsumer')));
    gh.lazySingleton<_i25.ProductRepository>(
        () => _i26.ProductRepositoryImpl(gh<_i23.ProductRemoteDataSource>()));
    gh.lazySingleton<_i27.RemoveProductFromCartUseCase>(
        () => _i27.RemoveProductFromCartUseCase(gh<_i10.CartRepository>()));
    gh.lazySingleton<_i28.RemoveProductFromFavoriteListUseCase>(() =>
        _i28.RemoveProductFromFavoriteListUseCase(
            gh<_i25.ProductRepository>()));
    gh.lazySingleton<_i29.ResetPasswordUseCase>(
        () => _i29.ResetPasswordUseCase(gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i30.SearchForProductsUseCase>(
        () => _i30.SearchForProductsUseCase(gh<_i25.ProductRepository>()));
    gh.factory<_i31.TokensCubit>(() => _i31.TokensCubit(
          gh<_i12.CheckIfTokensExistUseCase>(),
          gh<_i13.DeleteTokensUseCase>(),
        ));
    gh.lazySingleton<_i32.UpdateUserLocationUseCase>(
        () => _i32.UpdateUserLocationUseCase(gh<_i21.MapRepository>()));
    gh.lazySingleton<_i33.UserLocalDataSource>(
        () => _i33.UserLocalDataSourceImpl());
    gh.lazySingleton<_i34.UserLoginUseCase>(
        () => _i34.UserLoginUseCase(authRepository: gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i35.UserRemoteDataSource>(() =>
        _i35.UserRemoteDataSourceImpl(
            gh<_i3.ApiConsumer>(instanceName: 'mainApiConsumer')));
    gh.lazySingleton<_i36.UserRepository>(() => _i37.UserRepositoryImpl(
          gh<_i33.UserLocalDataSource>(),
          gh<_i35.UserRemoteDataSource>(),
        ));
    gh.lazySingleton<_i38.UserSignUpUseCase>(
        () => _i38.UserSignUpUseCase(authRepository: gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i39.VerifyOtpUseCase>(
        () => _i39.VerifyOtpUseCase(gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i40.AddOrEditProductReviewUseCase>(
        () => _i40.AddOrEditProductReviewUseCase(gh<_i25.ProductRepository>()));
    gh.lazySingleton<_i41.AddProductToCartUseCase>(
